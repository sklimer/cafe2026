...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-development-key-for-telegram-mini-app')
...
INSTALLED_APPS = [
    ...
    # Local apps - БЕЗ ПРЕФИКСА 'backend.'
    'core',
    'users',
    'restaurants',
    'catalog',
...
#         'NAME': os.environ.get('DB_NAME', 'telegram_mini_app'),
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'timeout': 20,  # Increase timeout for database locks
...
# Custom user model
AUTH_USER_MODEL = 'users.User'  # ✅ Только 'users.User'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'api.authentication.TelegramAuthentication',  # Add Telegram authentication
    ),
